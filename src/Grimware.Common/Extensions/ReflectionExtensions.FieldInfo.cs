...
namespace Grimware.Extensions
{
    partial class ReflectionExtensions
    {
        ...
        public static TAttribute GetFirstAttributeOfType<TAttribute>(this FieldInfo field) where TAttribute : Attribute
        {
        ...
        public static TAttribute GetFirstAttributeOfTypeIfExists<TAttribute>(this FieldInfo field) where TAttribute : Attribute
        {
        ...
        public static TAttribute GetSingleAttributeOfType<TAttribute>(this FieldInfo field) where TAttribute : Attribute
        {
        ...
        public static TAttribute GetSingleAttributeOfTypeIfExists<TAttribute>(this FieldInfo field) where TAttribute : Attribute
        {
        ...
        public static Attribute TryGetSingleAttributeOfType(this FieldInfo field, Type attributeType, Func<IEnumerable<Attribute>, Attribute> selector)
        {
