...
namespace Grimware.Extensions
{
    public static class StringExtensions
    {
        ...
        public static DateTime? ToDateTime(this string source, string format, IFormatProvider provider, DateTimeStyles style, bool adjustCentury = false) =>
            format != null
                ? ToDateTime(source, new[] {format}, provider, style, adjustCentury)
                : throw new ArgumentNullException(nameof(format));

        public static DateTime? ToDateTime(this string source, string[] formats, IFormatProvider provider, DateTimeStyles style, bool adjustCentury = false)
        {
            if (formats == null)
